...
<h1 class="text-center">Sport Club<span class="d"> - Edit Your Data</span></h1>
<h2 class="text-center m">Edit Your Data</h2>
...
<form class="container" method="post" action="Save">
    <div class="row">
        <div class="col-md-6">
            <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" name="name" required value="<%=analysis[0]%>">
        ...
        <div class="col-md-6">
            <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" name="surname" required value="<%=analysis[1]%>">
    ...
    <div class="row pt10">
        <div class="col-md-4 col-md-offset-4 np">
            <div class="col-xs-4">
                <div class="user-input-wrp">
                    <br/>
                    <input type="number" class="inputText" name="day" required value="<%=analysis[2]%>">
            ...
            <div class="col-xs-4">
                <div class="user-input-wrp">
                    ...
                    <select class="inputText" name="month" required value="<%=analysis[3]%>">
            ...
            <div class="col-xs-4">
                <div class="user-input-wrp">
                    <br/>
                    <input type="number" class="inputText" name="year" required value="<%=analysis[4]%>">
    ...
    <div class="row pt10">
        ...
        <div class="col-md-10 col-xs-8">
            <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" name="street" required value="<%=analysis[5]%>">
        ...
        <div class="col-md-2 col-xs-4">
            <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" name="streetNumber" required value="<%=analysis[6]%>">
    ...
    <div class="row pt10">
        <div class="col-xs-6">
            <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" name="city" required value="<%=analysis[7]%>">
        ...
        <div class="col-xs-6">
            <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" name="nap" required value="<%=analysis[8]%>">
    ...
    <div class="row pt10">
        <div class="col-md-6">
            <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" name="email" required value="<%=analysis[9]%>">
        ...
        <div class="col-md-6">
            <div class="user-input-wrp">
                <br/>
                <input type="text" class="inputText" name="number" required value="<%=analysis[10]%>">
    ...
    <div class="row pt10">
        <div class="col-md-6">
            <h3>Hobby</h3>
            <textarea name="hobby" class="col-md-12"><%=analysis[12]%></textarea>
        </div>

        <div class="col-md-6">
            <h3>Professione</h3>
            <textarea name="work" class="col-md-12"><%=analysis[13]%></textarea>
        </div>
    </div>

    <div class="row pt10">
        <div class="col-md-12 pt10">
            <input class="pull-right col-md-1 button" type="submit" formaction="check.jsp" value="Salva>">
            <div class="pull-right ph5">&nbsp;</div>
            <input class="pull-right col-md-2 button" type="submit" formaction="insert.html" value="Modifica">
        </div>
    </div>
</form>
